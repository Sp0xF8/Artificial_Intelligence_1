...
class simple_KNN:
    ...
    def fit(self,X,y):
        ...
        #print(f"labelsPresent{self.labelsPresent}")= [0,1,2]
    ...
    def predict(self,newItems):
        ...
        for item in range(numToPredict):
            ...
            predictions[item] = self.predict_new_item(newItems[item])
    ...
    def predict_new_item(self,newItem):
        ...
        closestK = get_ids_of_k_closest(distFromNewItem,K)
        ...
        for k in range(0,K-1):
            ...
            #print(f"labelcounts[thislabel]{labelcounts[thislabel]}")#
            
            #Prediction is highest labelcount
            #thisPrediction = numpy.where(labelcounts == numpy.amax(labelcounts))
            thisPrediction = np.max(labelcounts)
